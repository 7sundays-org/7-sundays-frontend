  ...
  return (
    ...
    >
      <div className="flex flex-col gap-10 md:flex-row md:items-center md:gap-[10px]">
        {image?.url && (
          <div className="relative aspect-[892/988] w-full shrink-0 overflow-hidden rounded-[16px] bg-neutral-200 md:w-[55%]">
            <PrismicNextImage
              field={image}
              fill
              fallbackAlt=""
        ...
        <div className="flex flex-1 flex-col gap-[45px] md:px-[90px]">
          {name && (
            <h2 className="font-serif text-[2.75rem] leading-[1.04] font-extrabold tracking-[-0.02em] text-primary md:text-[70px]">
              {name}
            </h2>
          )}
          {role && (
          ...
          {story && (
            <div className="flex max-w-[586px] flex-col gap-6 font-sans text-[1.5rem] leading-snug font-medium text-foreground md:text-[35px] md:leading-[48px]">
